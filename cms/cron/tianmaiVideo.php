<?
// --------------------------------------------------------------------------
// File name   : tianmaiVideo.php
// Description : 将天脉提供的视频导入到CMS
// Requirement : PHP4/PHP5 ([url]http://www.php.net[/url])
// Copyright(C), handong, 2013, All Rights Reserved.
// Author: handong ([email]handong@v1.cn[/email]) 
// 例子 php tianmaiVideo.php
// --------------------------------------------------------------------------
$channel='vodone';   //频道
$uid='1053';        //用户ID
...
$uploadDir="/VODONE/transcode/videoSourceFTP/tianmai/";  //上传视频地址
