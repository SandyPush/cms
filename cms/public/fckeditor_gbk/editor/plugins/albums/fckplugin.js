...
FCKalbums.prototype.Execute = function(){
	/*
	parent.tb_show('≤Â»Î◊ÈÕº','/fckeditor/editor/plugins/albums/form.html?TB_iframe=true&height=500&width=750&modal=false',false);
	try{
	...
	*/
	parent.$(function() {
		...
		if(browser.chrome){
			...
			var config={title:'≤Â»Î◊ÈÕº',autoOpen: false,modal:true,height:500,width:800,resizable: false,autoResize: true};
		}else{		
			var config={title:'≤Â»Î◊ÈÕº',autoOpen: false,modal:true,height:500,width:750,resizable: false,autoResize: true};
		}
